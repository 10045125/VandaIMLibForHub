...
public class SwitchButton extends CompoundButton {
	...
	public SwitchButton(Context context, AttributeSet attrs, int defStyle) {
		...
		mConf.setRadius(ta.getInt(R.styleable.SwitchButton_radius_,
	...
	private int measureWidth(int measureSpec) {
		...
		int specMode = MeasureSpec.getMode(measureSpec); // 保存了测量需要的模式
		int specSize = MeasureSpec.getSize(measureSpec); // 最小值
