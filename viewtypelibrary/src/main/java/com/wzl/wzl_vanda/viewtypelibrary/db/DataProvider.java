...
public class DataProvider extends ContentProvider {
    ...
    public static final String AUTHORITY = "com.wzl_vanda.recyclerviewdemo";
    ...
    public static final String ALL_ITEMS_CONTENT_TYPE = "vnd.android.cursor.dir/vnd.wzl_vanda.all.items";//Demo列表
    ...
    public Cursor queryData(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        synchronized (obj) {
            SQLiteQueryBuilder queryBuilder = new SQLiteQueryBuilder();
            queryBuilder.setTables(matchTable(uri));
            String offset = uri.getQueryParameter("offset");
