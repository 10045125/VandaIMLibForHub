...
public abstract class ArrayRecyclerAdapter<E>
        extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements List<E> {
...
//    public void addAllTop(List<E> list_) {
//        synchronized (lock) {
//            for (int i = list_.size() - 1; i >= 0; i--) {
//                ((LinkedList) list).addFirst(list_.get(i));
...
//////                ((LinkedList)list).addFirst(collection);
//////            }
////            if (list.add(collection)) {
////                notifyItemRangeInserted(lastIndex, collection.size());
////                return true;
////            } else {
////                return false;
