...
public class RecordButton extends Button {
  public static  int BACK_RECORDING= R.drawable.voice_shape_selector_bg;//chat_voice_bg_pressed;
  public static  int BACK_IDLE = R.drawable.edittext_shape_bg;//chat_voice_bg;
  public static  int SLIDE_UP_TO_CANCEL = 0;
  public static  int RELEASE_TO_CANCEL = 1;
  private static  int MIN_INTERVAL_TIME = 1000;// 2s
  private static int[] recordImageIds = {R.mipmap.chat_icon_voice0,
      R.mipmap.chat_icon_voice1, R.mipmap.chat_icon_voice2,
      R.mipmap.chat_icon_voice3, R.mipmap.chat_icon_voice4,
      R.mipmap.chat_icon_voice5};
