 ...
 */
public class ChatOtherImageViewBinder extends DataBinder<ChatOtherImageViewBinder.ViewHolder> {

//    private List<SampleData> mDataSet = new ArrayList<>();

    public ChatOtherImageViewBinder(DataBindAdapter dataBindAdapter) {
