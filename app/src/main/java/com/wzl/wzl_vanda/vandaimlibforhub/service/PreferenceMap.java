...
import com.wzl.wzl_vanda.vandaimlibforhub.application.MyApplication;
...
public class PreferenceMap {
  ...
  public boolean isNotifyWhenNews() {
    return pref.getBoolean(NOTIFY_WHEN_NEWS,
            MyApplication.getContext().getResources().getBoolean(R.bool.defaultNotifyWhenNews));
  }
  ...
  boolean getBooleanByResId(int resId) {
    return MyApplication.getContext().getResources().getBoolean(resId);
  }
