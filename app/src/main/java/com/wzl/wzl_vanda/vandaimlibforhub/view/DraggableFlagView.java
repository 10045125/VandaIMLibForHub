...
/**
 * Created by wzl_vanda on 15/8/11.
 * 作者：wzl_vanda on 15/8/11 12:22
 * 邮箱：806594174@qq.com
 */
...
public class DraggableFlagView extends View {
    ...
    public DraggableFlagView(Context context, AttributeSet attrs) {
        ...
        for (int i = 0; i < indexCount; i++) {
            ...
            if (attrIndex == R.styleable.DraggableFlagView_tipsColor) {
    ...
    private void init(Context context) {
        ...
        textPaint.setTextSize(ABTextUtil.sp2px(context, 10));
